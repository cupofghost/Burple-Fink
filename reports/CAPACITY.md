...
### car_models (1218 names, gru, seed 1337) — best held-out loss
| layers | h=64 | h=128 | h=256 | h=384 |
|---|---:|---:|---:|---:|
| 1 | 2.3872 | **2.3847** | 2.3922 | 2.4007 |
| 2 | — | — | — | — |
best: h=128 l=1 (72,834 params, 70 params/name)

### car_models (1218 names, lstm, seed 1337) — best held-out loss
| layers | h=64 | h=128 | h=256 | h=384 |
|---|---:|---:|---:|---:|
| 1 | 2.3941 | 2.3929 | **2.3815** | 2.3892 |
| 2 | 2.3902 | 2.4056 | 2.3885 | 2.4017 |
...
The main grid — training seed and split seed both 1337. The replicate sweeps behind finding
2 are not listed here (they roughly triple the row count); every one of them is a JSON file
in `reports/_capacity/`, and `--summary --all-seeds` prints them.
...
| `car_models` | 1035 | gru | 64 | 1 | 25,218 | 2.3872 | 10 | 2.1796 | +0.208 | 9 |
| `car_models` | 1035 | gru | 128 | 1 | 72,834 | 2.3847 | 10 | 1.9772 | +0.407 | 11 |
| `car_models` | 1035 | gru | 256 | 1 | 241,794 | 2.3922 | 7 | 1.9989 | +0.393 | 26 |
| `car_models` | 1035 | gru | 384 | 1 | 509,058 | 2.4007 | 6 | 1.9514 | +0.449 | 40 |
...
| `car_models` | 1035 | lstm | 256 | 2 | 842,370 | 2.3885 | 10 | 1.9675 | +0.421 | 53 |
| `car_models` | 1035 | lstm | 384 | 2 | 1,852,290 | 2.4017 | 6 | 2.1032 | +0.299 | 96 |
...
| `english_words` | 7336 | lstm | 64 | 2 | 61,181 | 2.0483 | 20 | 1.7807 | +0.268 | 172 |
