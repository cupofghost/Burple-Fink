...
|------|--------|-------|----------------|-------|
| `car_manufacturers.txt` | Vehicles & Transport | 590 | seed + WS-17 | Real worldwide marques. Grown 159 → 590 in wave 3, weighted toward defunct and historical makes (pre-war US independents, British, French, German, Italian, Eastern bloc) to fix the dataset-too-small finding. |
| `car_models.txt` | Vehicles & Transport | 1,218 | seed + WS-17 | Real model names. Grown 257 → 1,218 in wave 3; bulk of the additions are JDM-only nameplates, European Fiat/Lancia/Renault/Citroen lines, and dead American nameplates. |
...
| `motorcycle_brands.txt` | Vehicles & Transport | 309 | `claude/next-task-tnbsmq` + WS-17 | Harley-Davidson through Zongshen. Grown 63 → 309 in wave 3 with British interwar, Italian, German, Czech/Polish/Soviet and pre-war Japanese makes. |
...
| `spacecraft.txt` | Space & Sky | 593 | `claude/next-three-items-nj7dyj` | Real spacecraft, satellites, and mission names from NASA, ESA, JAXA, CNSA. Includes rovers, orbiters, landers, and space stations. Mix of acronyms (GOES, TESS) and full names (Voyager, Cassini). |
...
| `birds_wingspan.tsv` | Animals | 617 | WS-21 | WS-21 dual-output, 2026-08-05. IOC/AOS common names, flightless species excluded. Central estimates, ±~10%. **Signal: strongest in the batch** — the trailing group noun is a near-deterministic size class, and the cue lands at the end of the string. |
| `dinosaurs_length.tsv` | Nature | 405 | WS-21 | WS-21 dual-output, 2026-08-05. Substituted for a cities/population set, whose value would have been independent of spelling. Published figures disagree 20%+. **Signal: strong morphology, moderate in practice** — `-saurus` covers 1–26 m. |
| `dog_breeds_weight.tsv` | Animals | 348 | WS-21 | WS-21 dual-output, 2026-08-05. Breed-standard midpoints averaged across sexes, whole kg — a size class, not a measurement. **Signal: strong** — size words appear literally (Toy, Miniature, Giant) and group morphemes are size-bound. |
| `mountains_height.tsv` | Nature | 386 | WS-21 | WS-21 dual-output, 2026-08-05. Spread across ranges rather than a top-N list; elevations firm. **Signal: moderate, weaker than it looks** — the commonest prefix `Mount` spans 1085–6190 m, and 50 Colorado fourteeners sit in a 130 m band that flatters the value head. |
| `pharma_drugs_year.tsv` | Medicine | 795 | WS-21 | WS-21 dual-output, 2026-08-05. First approval in a major market, not US-only (a US rule would misdate metformin by decades). **Signal: strong** — WHO INN stems are era-stamped by construction; but `-mab` alone spans 1986–2024. |
| `spacecraft_year.tsv` | Space | 370 | WS-21 | WS-21 dual-output, 2026-08-05. Launch year is a single unambiguous event, so values are firm. **Signal: moderate, mixed** — Sputnik/Venera/Sentinel are date stamps, but the classical-name convention (Galileo, Juno, Psyche) spreads thinly across all 68 years. |
| `birds.txt` | Nature | 863 | Claude Code \| Opus 5 \| medium | Bird common names recalled from general ornithological and field-guide knowledge, weighted toward North America and Europe with worldwide coverage; possessive apostrophes dropped (Wilsons Warbler, Stellers Jay). |
| `board_games.txt` | Games & Music | 585 | Claude Code \| Opus 5 \| medium | Recalled from general knowledge of the BoardGameGeek hobby canon, classic mass-market titles, traditional abstract and folk games, and tabletop wargames and RPGs; numerals and punctuation were dropped from titles (Memoir 44, Baccarat-style flankers, edition numbers). Not cross-checked against BoardGameGeek in this session. |
| `cheeses.txt` | Food & Drink | 421 | Claude Code \| Opus 5 \| medium | Recalled from general knowledge of European PDO and AOP cheese registers plus well-known British, American, Middle Eastern, Nordic and Latin American cheeses; accents and apostrophes were transliterated to plain ASCII. Not cross-checked against a register in this session. |
| `cocktails.txt` | Food & Drink | 459 | Claude Code \| Opus 5 \| medium | Recalled from general knowledge of the IBA official cocktail list, the Savoy Cocktail Book canon, classic tiki drinks and widely-served modern bar standards; accented and punctuated names were transliterated to plain ASCII. Not cross-checked against a printed source in this session. |
| `dog_breeds.txt` | Nature | 461 | Claude Code \| Opus 5 \| medium | Recalled from general knowledge of AKC, FCI, UKC and Kennel Club breed registers plus well-known landrace and regional breeds; not cross-checked against a register in this session. |
| `greek_myth.txt` | Words, Names & Places | 755 | Claude Code \| Opus 5 \| medium | Recalled from standard classical mythology reference (Hesiod, Homer, Ovid, Apollodorus and common handbooks): Olympians, Titans, primordials, heroes, nymphs, monsters, rivers and places, with Roman equivalents. High confidence; Latin transliterations used and variant spellings collapsed to one form. |
| `locomotives.txt` | Vehicles & Transport | 395 | Claude Code \| Opus 5 \| medium | Recalled from knowledge of British named steam classes (GWR Castle/Hall/Manor/King, LNER A1/A3/A4, LMS Princess/Duchess/Jubilee/Royal Scot, SR Merchant Navy/West Country/Battle of Britain, BR Standard/Clan), narrow-gauge Welsh and Cumbrian railways, early pioneers, US and continental types. Running numbers and apostrophes stripped; deliberately kept conservative rather than padded. |
| `metal_bands.txt` | Games & Music | 663 | Claude Code \| Opus 5 \| medium | Recalled from general knowledge of heavy metal and hard rock across NWOBHM, thrash, death, doom, black, power, progressive, metalcore, grunge and stoner scenes; stylised punctuation was normalised (AC/DC to ACDC, Guns N Roses) and gratuitously violent or slur-adjacent band names were deliberately excluded. Not cross-checked against Encyclopaedia Metallum in this session. |
| `minerals_gems.txt` | Nature | 624 | Claude Code \| Opus 5 \| medium | Mineral species and gem trade names recalled from general mineralogy knowledge (Dana/Mindat-style naming); spellings believed correct but not checked against a database in this session. |
| `mountains.txt` | Nature | 523 | Claude Code \| Opus 5 \| medium | Named peaks worldwide recalled from general geography and mountaineering knowledge; accented and non-Latin names transliterated (Popocatepetl, Gerlachovsky Stit), and peaks whose usual names contain digits (K2) were omitted. |
| `mushrooms.txt` | Nature | 441 | Claude Code \| Opus 5 \| medium | Fungus common names recalled from general mycology and field-guide knowledge, weighted toward British and North American guide names plus culinary species; apostrophes dropped (Dryads Saddle, Dead Mans Fingers). |
| `perfumes.txt` | Design & Brands | 639 | Claude Code \| Opus 5 \| medium | Recalled from general knowledge of designer and niche fragrance houses (Chanel, Dior, Guerlain, YSL, Creed, Tom Ford, Serge Lutens, Byredo, Parfums de Marly and others); French names were transliterated to plain ASCII and numbered flankers such as Baccarat Rouge 540 had the numeral dropped. Not cross-checked against a fragrance database in this session. |
| `pharma_drugs.txt` | Science & Medicine | 2223 | Claude Code \| Opus 5 \| medium | Recalled from knowledge of INN generic stems (-mab, -tinib, -prazole, -olol, -sartan, -gliflozin, -parib, -ciclib, -vir) plus widely marketed brand names. High confidence these are real approved or late-stage agents; a small number of recent investigational names may be less certain. |
| `plants_flowers.txt` | Nature | 634 | Claude Code \| Opus 5 \| medium | Common names of garden and wild plants recalled from general horticultural and field-guide knowledge; apostrophes stripped (Ladys Mantle, Queen Annes Lace) to fit the shared vocabulary. |
| `sailing_ships.txt` | Vehicles & Transport | 468 | Claude Code \| Opus 5 \| medium | Recalled from knowledge of naval and merchant marine history: age-of-sail warships, clippers, tall ships, ocean liners, polar research vessels and twentieth-century capital ships. Non-Latin and accented names transliterated; hull numbers and honorifics dropped. |
| `stars_constellations.txt` | Space & Sky | 503 | Claude Code \| Opus 5 \| medium | Recalled from the IAU Catalog of Star Names, the 88 official constellations, and common names for Messier/NGC deep-sky objects. High confidence; catalogue designations and possessive apostrophes were dropped. |
| `typefaces.txt` | Design & Brands | 463 | Claude Code \| Opus 5 \| medium | Recalled from knowledge of type foundry catalogues, system font sets and Google Fonts; these are well-known real typeface families, though a handful of family-vs-variant boundaries may be imprecise. |
| `video_games.txt` | Games & Music | 753 | Claude Code \| Opus 5 \| medium | Recalled from general knowledge of arcade, console and PC releases from the late nineteen-seventies to the present, across major franchises and indie titles; series numerals and post-colon subtitles were dropped so entries carry only the base title. Not cross-checked against a games database in this session. |
